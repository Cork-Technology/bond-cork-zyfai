...
<!-- Sources of truth: Slack live-deployment announcement (2026-07-10), cork/docs/integration.md,
     cork/script/Deploy.s.sol, cork/docs/examples/lib.mjs (LOP_ADDRESS), cork/docs/fork-testing.md. -->
...
1. **Phoenix stack** — follow `cork/docs/fork-testing.md` Option B exactly: start
...
2. **This repo's contracts** — from the repo root:
   `CONTROLLER=... POOL_MANAGER=... LOP=0x111111125421cA6dc452d289314280a0f8842A65 forge script cork/script/Deploy.s.sol --rpc-url http://127.0.0.1:8545 --broadcast --private-key <admin-pk>`
